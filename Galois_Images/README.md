...
`Index_Verification` verifies the claims made in Lemmas 3.2, 3.7, 3.10, and 3.13 of our paper. In particular, we verify that the index of the 2-adic image of a CM elliptic curve with CM discriminants -4, -8, or -16 coincide with the index of the mod 8 image. We also verify that the index of the 3-adic image of an elliptic curve with CM discriminant -3 coincides with the index of the mod 9 image.
